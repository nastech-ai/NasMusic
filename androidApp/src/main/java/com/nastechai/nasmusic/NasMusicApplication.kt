...
import com.nastechai.nasmusic.service.backup.AutoBackupScheduler
...
import org.nastechai.crashlytics.configCrashlytics
import java.lang.reflect.Field

class NasMusicApplication :
    Application(),
    KoinComponent,
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            androidContext(this@NasMusicApplication)
            loadAllModules()
