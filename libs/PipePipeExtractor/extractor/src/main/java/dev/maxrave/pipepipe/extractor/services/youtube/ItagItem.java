...
import static dev.nastechai.pipepipe.extractor.MediaFormat.M4A;
import static dev.nastechai.pipepipe.extractor.MediaFormat.MPEG_4;
import static dev.nastechai.pipepipe.extractor.MediaFormat.WEBM;
import static dev.nastechai.pipepipe.extractor.MediaFormat.WEBMA;
import static dev.nastechai.pipepipe.extractor.MediaFormat.WEBMA_OPUS;
import static dev.nastechai.pipepipe.extractor.MediaFormat.v3GPP;
import static dev.nastechai.pipepipe.extractor.services.youtube.ItagItem.ItagType.AUDIO;
import static dev.nastechai.pipepipe.extractor.services.youtube.ItagItem.ItagType.VIDEO;
import static dev.nastechai.pipepipe.extractor.services.youtube.ItagItem.ItagType.VIDEO_ONLY;
...
public class ItagItem implements Serializable {
    ...
    private static final ItagItem[] ITAG_LIST = {
            ...
            // Add new AV1 format video-only streams
