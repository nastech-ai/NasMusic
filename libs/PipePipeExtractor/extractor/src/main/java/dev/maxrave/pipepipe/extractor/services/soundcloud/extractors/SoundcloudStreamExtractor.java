...
import static dev.nastechai.pipepipe.extractor.services.soundcloud.SoundcloudParsingHelper.clientId;
import static dev.nastechai.pipepipe.extractor.services.soundcloud.SoundcloudParsingHelper.getAllImagesFromTrackObject;
import static dev.nastechai.pipepipe.extractor.stream.AudioStream.UNKNOWN_BITRATE;
import static dev.nastechai.pipepipe.extractor.stream.Stream.ID_UNKNOWN;
...
import dev.nastechai.pipepipe.extractor.exceptions.GeographicRestrictionException;
import dev.nastechai.pipepipe.extractor.exceptions.ParsingException;
import dev.nastechai.pipepipe.extractor.exceptions.SoundCloudGoPlusContentException;
...
import dev.nastechai.pipepipe.extractor.stream.DeliveryMethod;
import dev.nastechai.pipepipe.extractor.stream.Description;
import dev.nastechai.pipepipe.extractor.stream.Stream;
