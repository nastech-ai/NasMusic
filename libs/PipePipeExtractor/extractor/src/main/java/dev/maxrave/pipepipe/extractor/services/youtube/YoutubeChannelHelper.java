...
import static dev.nastechai.pipepipe.extractor.services.youtube.YoutubeParsingHelper.defaultAlertsCheck;
...
public final class YoutubeChannelHelper {
    ...
    public static String getChannelName(@SuppressWarnings("OptionalUsedAsFieldOrParameterType")
        ...
        return channelHeader.map(header -> {
                ...
                .orElseGet(() -> {
                    JsonObject microformatDataRenderer = jsonResponse.getObject("microformat")
                            .getObject("microformatDataRenderer");
                    if (microformatDataRenderer != null) {
                        try {
                            return Optional.ofNullable(microformatDataRenderer.getString(TITLE))
