package dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators;

import dev.nastechai.pipepipe.extractor.downloader.Response;
import dev.nastechai.pipepipe.extractor.services.youtube.DeliveryType;
import dev.nastechai.pipepipe.extractor.services.youtube.ItagItem;
import dev.nastechai.pipepipe.extractor.utils.ManifestCreatorCache;
...
import static dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.ALR_YES;
import static dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.RN_0;
import static dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SEGMENT_TIMELINE;
import static dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SQ_0;
import static dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.buildAndCacheResult;
import static dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateDocumentAndDoCommonElementsGeneration;
import static dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTemplateElement;
import static dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTimelineElement;
import static dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.getInitializationResponse;
import static dev.nastechai.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.setAttribute;
import static dev.nastechai.pipepipe.extractor.utils.Utils.EMPTY_STRING;
import static dev.nastechai.pipepipe.extractor.utils.Utils.isBlank;
