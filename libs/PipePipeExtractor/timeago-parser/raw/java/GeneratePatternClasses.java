...
import dev.nastechai.pipepipe.extractor.timeago.TimeAgoUnit;
    ...
    public static void main(String[] args) throws FileNotFoundException, JsonParserException {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            try (final FileWriter fileOut = new FileWriter(
                    "timeago-parser/src/main/java/dev/nastechai/pipepipe/extractor/timeago/patterns/" +
                            languageCode + ".java")) {
                final String test = INFO_CLASS_GENERATED + "\n" +
                        "\n" +
                        "package dev.nastechai.pipepipe.extractor.timeago.patterns;\n\n" +
                        "import dev.nastechai.pipepipe.extractor.timeago.PatternsHolder;\n" +
                        (specialCasesString.length() > 0 ? "import dev.nastechai.pipepipe.extractor.timeago.TimeAgoUnit;\n" : "") +
                        "\n" +
