...
object MEDIA_NOTIFICATION {
    ...
    const val NOTIFICATION_CHANNEL_NAME = "NasMusic Playback Notification"
    const val NOTIFICATION_CHANNEL_ID = "NasMusic Playback Notification ID"
}
