package com.nastechai.data.dataStore
...
import com.nastechai.domain.manager.DataStoreManager.Values.AI_PROVIDER_GEMINI
import com.nastechai.domain.manager.DataStoreManager.Values.FALSE
import com.nastechai.domain.manager.DataStoreManager.Values.GITHUB
import com.nastechai.domain.manager.DataStoreManager.Values.LOCAL_PLAYLIST_FILTER_OLDER_FIRST
import com.nastechai.domain.manager.DataStoreManager.Values.PROXY_TYPE_HTTP
import com.nastechai.domain.manager.DataStoreManager.Values.PROXY_TYPE_SOCKS
import com.nastechai.domain.manager.DataStoreManager.Values.REPEAT_ALL
import com.nastechai.domain.manager.DataStoreManager.Values.REPEAT_MODE_OFF
import com.nastechai.domain.manager.DataStoreManager.Values.REPEAT_ONE
...
import com.nastechai.common.QUALITY as COMMON_QUALITY
...
internal class DataStoreManagerImpl(
    ...
    override val lyricsProvider =
        settingsDataStore.data.map { preferences ->
            preferences[LYRICS_PROVIDER] ?: NASMUSIC
        }
