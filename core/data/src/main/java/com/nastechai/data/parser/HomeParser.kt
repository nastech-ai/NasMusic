package com.nastechai.data.parser
...
import com.nastechai.kotlinytmusicscraper.models.*
import com.nastechai.kotlinytmusicscraper.pages.ArtistPage
import com.nastechai.kotlinytmusicscraper.pages.ExplorePage
import com.nastechai.kotlinytmusicscraper.pages.RelatedPage
...
fun Thumbnail.toThumbnail(): com.nastechai.domain.data.model.searchResult.songs.Thumbnail =
    com.nastechai.domain.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<com.nastechai.domain.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<com.nastechai.domain.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
