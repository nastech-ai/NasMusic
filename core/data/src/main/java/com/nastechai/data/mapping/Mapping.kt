package com.nastechai.data.mapping

import android.text.Html
import com.nastechai.data.parser.toListThumbnail
import com.nastechai.domain.data.model.browse.album.Track
import com.nastechai.domain.data.model.canvas.CanvasResult
import com.nastechai.domain.data.model.mediaService.SponsorSkipSegments
import com.nastechai.domain.data.model.metadata.Line
...
import com.nastechai.kotlinytmusicscraper.models.AccountInfo
...
import com.nastechai.kotlinytmusicscraper.models.SearchSuggestions
import com.nastechai.kotlinytmusicscraper.models.SongItem
import com.nastechai.kotlinytmusicscraper.models.VideoItem
import com.nastechai.kotlinytmusicscraper.models.WatchEndpoint
import com.nastechai.kotlinytmusicscraper.models.response.PipedResponse
import com.nastechai.kotlinytmusicscraper.models.sponsorblock.SkipSegments
import com.nastechai.kotlinytmusicscraper.models.youtube.Transcript
import com.nastechai.kotlinytmusicscraper.models.youtube.YouTubeInitialPage
import com.nastechai.spotify.model.response.spotify.CanvasResponse
import com.nastechai.spotify.model.response.spotify.SpotifyLyricsResponse
import org.nasmusic.lyrics.models.response.LyricsResponse
import org.nasmusic.lyrics.models.response.TranslatedLyricsResponse
import org.nasmusic.lyrics.parser.parseSyncedLyrics
import org.nasmusic.lyrics.parser.parseUnsyncedLyrics
...
internal fun Track.toSongItemForDownload(): SongItem =
    SongItem(
        ...
        artists =
            this.artists?.map {
                com.nastechai.kotlinytmusicscraper.models.Artist(
                    id = it.id ?: "",
                    name = it.name,
                )
            } ?: emptyList(),
        album =
            com.nastechai.kotlinytmusicscraper.models.Album(
                id = this.album?.id ?: "",
...
internal fun org.nasmusic.lyrics.domain.Lyrics.toLyrics(): Lyrics {
...
internal fun Lyrics.toLibraryLyrics(): org.nasmusic.lyrics.domain.Lyrics =
    org.nasmusic.lyrics.domain.Lyrics(
        lyrics =
            org.nasmusic.lyrics.domain.Lyrics.LyricsX(
                lines =
                    this.lines?.map {
                        org.nasmusic.lyrics.domain.Lyrics.LyricsX.Line(
                            endTimeMs = it.endTimeMs,
                            startTimeMs = it.startTimeMs,
                            syllables = listOf(),
                            words = it.words,
...
internal fun SearchSuggestions.toDomainSearchSuggestions(): com.nastechai.domain.data.model.searchResult.SearchSuggestions =
    com.nastechai.domain.data.model.searchResult.SearchSuggestions(
...
internal fun AccountInfo.toDomainAccountInfo(): com.nastechai.domain.data.model.account.AccountInfo =
    com.nastechai.domain.data.model.account.AccountInfo(
        name = this.name,
        email = this.email,
        pageId = this.pageId,
